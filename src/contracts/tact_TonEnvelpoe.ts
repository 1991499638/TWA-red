...
function initTonEnvelpoe_init_args(src: TonEnvelpoe_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeInt(src.amount, 257);
...
async function TonEnvelpoe_init(amount: bigint, size: bigint, content: Cell, min: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initTonEnvelpoe_init_args({ $$type: 'TonEnvelpoe_init_args', amount, size, content, min })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const TonEnvelpoe_errors: { [key: number]: { message: string } } = {
...
const TonEnvelpoe_types: ABIType[] = [
...
const TonEnvelpoe_getters: ABIGetter[] = [
...
const TonEnvelpoe_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SendEnvelope"}},
    {"receiver":"internal","message":{"kind":"typed","type":"GetEnvelope"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class TonEnvelpoe implements Contract {
    
    static async init(amount: bigint, size: bigint, content: Cell, min: bigint) {
        return await TonEnvelpoe_init(amount, size, content, min);
    }
    
    static async fromInit(amount: bigint, size: bigint, content: Cell, min: bigint) {
        const init = await TonEnvelpoe_init(amount, size, content, min);
        const address = contractAddress(0, init);
        return new TonEnvelpoe(address, init);
    }
    
    static fromAddress(address: Address) {
        return new TonEnvelpoe(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  TonEnvelpoe_types,
        getters: TonEnvelpoe_getters,
        receivers: TonEnvelpoe_receivers,
        errors: TonEnvelpoe_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SendEnvelope | GetEnvelope | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SendEnvelope') {
            body = beginCell().store(storeSendEnvelope(message)).endCell();
        }
